    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "Department", "Email", "FirstName", "LastName", "LeaveBalance", "PasswordHash", "Role" },
                values: new object[,]
                {
                    { 1, "IT", "employee@test.com", "Demo", "Employee", 20, "password123", "Employee" },
                    { 2, "HR", "manager@test.com", "Demo", "Manager", 30, "password123", "Manager" }
                });
